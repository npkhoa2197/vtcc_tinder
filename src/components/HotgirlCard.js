...
class HotgirlCard extends React.PureComponent {
  ...
  renderComments = (id) => {
    if (this.state.commentEnabled) {
      return <CommentList hotgirlId={id} />;
    }
    return null;
  };
  ...
  render() {
    ...
    return (
      <KeyboardAvoidingView style={[styles.container, { width: width - 40 }]} behavior="padding">
        ...
        <AnimatedHeart
          ...
          onDatePressCallback={onDatePress}
          hotgirlId={id}
        />
        ...
        <View style={styles.shadingContainer}>
          ...
          <View style={styles.buttonsContainer}>
            ...
            <MyButton
              onPress={() => this.animatedHeartRef.show()}
              text={I_WANT_BUTTON}
              textColor="orange"
            />
