...
import { View, Image, TouchableWithoutFeedback, Text, StyleSheet, Dimensions, KeyboardAvoidingView } from 'react-native';
import CustomTextInput from './CustomTextInput';
import { LOGINFORM_TITLE } from '../constants/strings';
...
class LoginDialog extends React.Component {
  ...
  render() {
    ...
    if (this.state.visible) {
      return (
        <KeyboardAvoidingView style={[outerContainer, { width, height }]} behavior="padding">
          <TouchableWithoutFeedback onPress={this.handleCancel}>
            <View style={[outerContainer, { width, height }]} />
          </TouchableWithoutFeedback>
          <View style={innerContainer}>
            <Text style={styles.introTextStyle}>{LOGINFORM_TITLE}</Text>
